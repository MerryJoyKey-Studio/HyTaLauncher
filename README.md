...
<p align="center">С Поддержкой Модов | With Mods Manager<br>Установка руссификатора из лаунчера!</p>
...
<p align="center">
  <b>Unofficial launcher for Hytale</b><br>
  <i>Неофициальный лаунчер для Hytale</i>
</p>
...
## TODO — План работ / Roadmap

- [x] **Дополнительное зеркало для скачивания файлов**
- [x] **Автоустановка руссификатора**
- [x] **Автоустановка онлайн-фикса** (Он ломает некоторые текстуры в интерфесах)
- [x] **Запуск локального сервера для игры с друзьями**
